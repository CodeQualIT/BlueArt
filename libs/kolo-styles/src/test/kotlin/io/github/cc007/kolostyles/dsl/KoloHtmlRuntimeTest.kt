...
import io.github.cc007.kolostyles.dsl.font.*
import io.github.cc007.kolostyles.dsl.layout.*
import io.github.cc007.kolostyles.dsl.layout.display.*
import io.github.cc007.kolostyles.dsl.layout.offset.insetX
import io.github.cc007.kolostyles.dsl.layout.offset.top
import io.github.cc007.kolostyles.dsl.sizing.*
import io.github.cc007.kolostyles.dsl.sizing.SizingAlpha.MD
import io.github.cc007.kolostyles.dsl.sizing.SizingNamed.*
...
class KoloHtmlRuntimeTest {
    ...
    @Test
    fun `stylesheet link outside render context uses the standalone build property`() {
        val previous = System.getProperty("kolo.build.sha")
        System.setProperty("kolo.build.sha", "library-build")
        try {
            ...
            html shouldBe """
                <html>
                  <head>
                    <link href="/css/generated/kolo.css?version=library-build&amp;kolo=" rel="stylesheet">
                  </head>
                </html>
            """.trimIndent() + "\n"
        } finally {
            if (previous == null) {
                System.clearProperty("kolo.build.sha")
            } else {
                System.setProperty("kolo.build.sha", previous)
            }
        }
    }
